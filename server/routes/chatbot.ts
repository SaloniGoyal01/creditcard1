  ...
  setTimeout(
    () => {
      if (
        ...
        (lowerMessage.includes("flag") || lowerMessage.includes("block"))
      ) {
        response = {
          success: true,
        ...
        lowerMessage.includes("false positive") ||
        lowerMessage.includes("legitimate") ||
        lowerMessage.includes("not fraud")
      ) {
        response = {
          success: true,
        ...
        lowerMessage.includes("moscow") ||
        lowerMessage.includes("russia")
      ) {
        response = {
          success: true,
          response:
        ...
        lowerMessage.includes("trust score") ||
        lowerMessage.includes("electronics world")
      ) {
        response = {
          success: true,
          response:
        ...
        response = {
          success: true,
          response:
            "🤔 I understand you're asking about fraud detection. Let me help:\n\n" +
